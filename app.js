...
const API_KEY = "jaweherncir@gmail.com_5ea8b7fd76f6105669847e96146ac33addfdbb97c1e5736851d957797872f17839d567b2";

// Source PDF file
const SourceFile = "./tarek.pdf";
// Comma-separated list of page indices (or ranges) to process. Leave empty for all pages. Example: '0,2-5,7-'.
const Pages = "";
// PDF document password. Leave empty for unprotected documents.
const Password = "";
// Destination XML file name
const DestinationFile = "./tarek.xml";
